...
<html>
  <head>
    ...
    {!! Html::style('public/assets/admin/plugins/datatables/jquery.dataTables.css') !!}
    ...
    <![endif]-->
    <!-- Theme style -->
    {!! Html::style('public/assets/admin/admin.css') !!}
    ...
    {!! Html::script('public/assets/admin/dist/js/pages/dashboard2.js') !!}
  </head>
  <body class="skin-blue sidebar-mini">
    ...
    {!! Html::script('public/assets/admin/dist/js/scripts.js') !!}
  </body>
</html>