...
<div class="content-wrapper">
  ...
  <div class="page-header">
      <h1><i class="glyphicon glyphicon-edit"></i> FAQ / Edit</h1>
  </div>
  </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('faq.update', $faq->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="title-field" name="title" class="form-control" value="{{ is_null(old("title")) ? $faq->title : old("title") }}"/>
                       @if($errors->has("title"))
                    ...
                    <textarea class="form-control" id="editor1" rows="3" name="description">{{ is_null(old("description")) ? $faq->description : old("description") }}</textarea>
                    ...
                    <input type="file" id="picture-field" name="picture" accept="image/x-png,image/gif,image/jpeg" class="form-control" value="{{ is_null(old("picture")) ? $faq->picture : old("picture") }}"/>
                    ...
                    <input type="file" id="picture-field" name="file1" accept="application/pdf,image/x-png,image/gif,image/jpeg" class="form-control" value="{{ is_null(old("file1")) ? $faq->file1 : old("file1") }}"/>
                       @if($errors->has("file1"))
                    ...
                    <input type="file" id="picture-field" name="file2" accept="application/pdf,image/x-png,image/gif,image/jpeg" class="form-control" value="{{ is_null(old("file2")) ? $faq->file2 : old("file2") }}"/>
                       @if($errors->has("file2"))
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('faq.index') }}"><i class="glyphicon glyphicon-backward"></i>  Back</a>
                </div>
            </form>
