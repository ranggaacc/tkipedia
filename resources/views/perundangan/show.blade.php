...
<div class="page-header">
        <h1>Perundangan / Show #{{$perundangans->id}}</h1>
        <form action="{{ route('perundangans.destroy', $artikel->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
