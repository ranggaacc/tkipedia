        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('artikels.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="file" id="file1-field" name="file1" accept="application/pdf,image/x-png,image/gif,image/jpeg" class="form-control" value="{{ old("file1") }}"/>
                       @if($errors->has("file1"))
                    ...
                    <input type="file" id="file2-field" name="file2" class="form-control" accept="application/pdf,image/x-png,image/gif,image/jpeg" value="{{ old("file2") }}"/>
                       @if($errors->has("file2"))
