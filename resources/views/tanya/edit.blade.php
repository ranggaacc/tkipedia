...
<div class="content-wrapper">
  ...
  <div class="page-header">
      <h1><i class="glyphicon glyphicon-edit"></i> Pertanyaan / Edit</h1>
  </div>
  </section>
    <!-- Main content -->
  <section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('tanya.update', $tanya->id) }}" enctype="multipart/form-data" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('title')) has-error @endif">
                       <label for="title-field">Title</label>
                    <input type="text" id="title-field" name="title" class="form-control" value="{{ is_null(old("title")) ? $tanya->title : old("title") }}"/>
                       @if($errors->has("title"))
                    ...
                    <textarea class="form-control" id="editor1" rows="3" name="description">{{ is_null(old("description")) ? $tanya->description : old("description") }}</textarea>
                    ...
                    <input type="file" id="picture-field" name="picture" class="form-control" value="{{ is_null(old("picture")) ? $tanya->picture : old("picture") }}"/>
                    ...
                    <input type="file" id="picture-field" name="file1" class="form-control" value="{{ is_null(old("file1")) ? $tanya->file1 : old("file1") }}"/>
                       @if($errors->has("file1"))
                    ...
                    <input type="file" id="picture-field" name="file2" class="form-control" value="{{ is_null(old("file2")) ? $tanya->file2 : old("file2") }}"/>
                       @if($errors->has("file2"))
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('tanya.index') }}"><i class="glyphicon glyphicon-backward"></i>  Back</a>
                </div>
            </form>
