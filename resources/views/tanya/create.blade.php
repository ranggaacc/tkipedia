...
<div class="content-wrapper">
  ...
  <div class="page-header">
      <h1><i class="glyphicon glyphicon-edit"></i> Pertanyaan / Create</h1>
  </div>
  </section>
    <!-- Main content -->
  <section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('tanya.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="file" id="picture-field" name="file1" class="form-control" value="{{ old("file1") }}"/>
                       @if($errors->has("file1"))
                    ...
                    <input type="file" id="picture-field" name="file2" class="form-control" value="{{ old("file2") }}"/>
                       @if($errors->has("file2"))
